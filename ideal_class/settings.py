"""
Django settings for ideal_class project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-=@x5duu8ts-__-+if02z3y1(u94w9lxzx6y0uk*50cr!7)-_!t')
...
CSRF_TRUSTED_ORIGINS = [
    'https://*.onrender.com',
    'https://ideal-classes.onrender.com',
]
...
WSGI_APPLICATION = 'ideal_class.wsgi.application'
...
if 'postgresql' in DATABASES['default'].get('ENGINE', ''):
    # Safely update OPTIONS to preserve parsed settings (e.g. SSL modes from dj-database-url)
...
# Session Configuration for Android App
